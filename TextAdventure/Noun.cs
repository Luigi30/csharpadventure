...
namespace TextAdventure
{
    class Noun : INoun
    {
        ...
        public List<Noun> Contents { get; set; }
        #endregion
        ...
        public String Put(Noun actor, Noun indirect_object, String verb_preposition = null, String indirect_object_preposition = null)
        {
            ...
            if (indirect_object.Contents == null)
            {
            ...
            else
            {
                ...
                if (GameManager.Instance.PC.Contents.Find(x => x.Name == Name) == null)
                {
                    return String.Format("You don't have {0}.\r\n", DefiniteName);
                }

                var direct_object = GameManager.Instance.PC.Contents.Find(x => x.Name == Name);

                GameManager.Instance.WorldItems.Find(x => x.Name == Name).Location = null;
                GameManager.Instance.WorldItems.Find(x => x.Name == indirect_object.Name).Contents.Add(this);
                GameManager.Instance.PC.Contents.Remove(direct_object);
        ...
        public String Drop(INoun actor, String verb_preposition = null)
        {
            ...
            var item = GameManager.Instance.PC.Contents.Find(x => x.Name == Name);
            if (item == null)
            {
                return String.Format("You don't have {0}.\r\n", DefiniteName);
            }
            ...
            {
                GameManager.Instance.PC.Contents.Remove(item);
